...
type Page = "discovery" | "collection";
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#6958c5] via-[#8c77e9] to-[#a089fa] flex flex-col">
      {/* Header */}
      <div className="w-full bg-white px-3 sm:px-4 pb-4 sm:pb-6 pt-6 sm:pt-8 flex flex-col items-center shadow">
        {/* Title Row */}
        <div className="flex items-center gap-2 mb-1">
          <span className="text-xl sm:text-2xl">🔥</span>
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-gray-900 tracking-wide text-center">
            Pokemon Collection App
          </h1>
        </div>
        <p className="text-gray-700 text-xs sm:text-sm font-medium mb-3 sm:mb-4 mt-1 text-center px-2">
          Discover, collect, and organize your favorite Pokemon!
        </p>
        {/* Tabs */}
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 mt-2 items-center justify-center">
          {/* Discover Tab */}
          <button
            onClick={() => setPage("discovery")}
            className={`flex items-center justify-center gap-2 px-6 py-2 rounded-full font-semibold text-sm sm:text-base shadow transition-all duration-150
              ${
                page === "discovery"
          ...
          >
            <GiPokecog className="text-base sm:text-lg" />
            <span className="whitespace-nowrap">Discover Pokemon</span>
          </button>
          {/* My Collection Tab */}
          <button
          ...
          >
            ...
            <span className="whitespace-nowrap">My Collection</span>
            <span
      ...
      {/* Main Content */}
      <div className="flex-1 flex justify-center items-start py-6 sm:py-10 px-3 sm:px-5">
